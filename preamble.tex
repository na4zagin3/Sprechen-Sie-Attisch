...
\else
  \ifxetex
    ...
    \newcommand{\kenten}[1]{\CJKunderdot{#1}}
...
\ifdefined\newfontfamily
  ...
  \ifFraktur
    ...
    \newfontfamily\germanfont[Script=Latin,Language=German,Mapping=tex-text,Numbers=OldStyle,CharacterVariant={11,13,14},Ligatures=Historic,
    BoldFont = UnifrakturMaguntia,
    BoldFeatures = {LetterSpace=12.0, WordSpace=1.1, Ligatures=NoCommon, Kerning=Off},
    ItalicFont = UnifrakturMaguntia,
    ItalicFeatures = {LetterSpace=12.0, WordSpace=1.1, Ligatures=NoCommon, Kerning=Off}]{UnifrakturMaguntia}
