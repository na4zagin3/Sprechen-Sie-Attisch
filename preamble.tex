  ...
  \ifFraktur
    ...
    \ifluatex
      ...
      \newfontfamily\germanfont[
        ...
        BoldFeatures={Renderer=HarfBuzz,LetterSpace=8.0,Ligatures=NoCommon,Kerning=Off},
        ItalicFont=UnifrakturMaguntia,
        ItalicFeatures={Renderer=HarfBuzz,LetterSpace=8.0,Ligatures=NoCommon,Kerning=Off}
      ]{UnifrakturMaguntia}
    \else
      \newfontfamily\germanfont[
        Script=Latin,
