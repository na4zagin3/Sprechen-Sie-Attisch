...
\switchcolumn
\section*{些細な規則と注意\addcontentsline{toc}{section}{\kenten{些細な規則と注意}}}
\switchcolumn*
...
\begin{japanese}
\item 言語をわがものとするうえで、その言語の\kenten{弱点}を見抜くことほど有用なものはない。
何がその言語に欠けているかが分かって初めて、なぜある言い回しを選び、ある概念の結びつきを好み、
また、なぜわれわれ自身の言語とは異なる仕方で表現するのかが、正しく理解できるようになる。
そうしてわれわれは、その言語の\kenten{精神}\—{}即ち特殊性の総体\—{}の肝が掴めるようになるのだ。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
さて、ギリシャ語の顕著な弱点の一は、形態の豊かさにもかかわらず、
\kenten{使いやすい受動態形が欠けている}ことだ。
受動態形の多くが中動態形と同形であることは\—{}明確さは言語の第一原理である故\—{}応用を難しくしている。どの道、多くの動詞には受動専用の形がそもそも存在しないのだ。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
したがって、ギリシャ語に特有の色調を写そうとするなら、何よりまず次の点に注意せねばならない。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\kenten{中動態と同形の受動態形はできるかぎり避け、ギリシャ人が一般にこれをどのように言い換えるかに注意すること。}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
この種の受動態形のうち、安心して用いうるのは、文脈からただちに受動と分かるものと、
頻用されて慣用となった一定のものに限られる。
\end{japanese}
\switchcolumn*
...
苦しめられる \textgreek[variant=ancient]{κάμνειν,}\\
法廷に立たされる \textgreek[variant=ancient]{εἰσιέναι εἰς
δικαστήριον,}\\
訴追される \textgreek[variant=ancient]{φεύγειν,}\\
……と思われる \textgreek[variant=ancient]{δοκεῖν,}\\
何か（害・苦痛などが）私に与えられる \textgreek[variant=ancient]{πάσχω τι,}\\
追放される \textgreek[variant=ancient]{ἐκπίπτειν,}\\
あるものを奪われる \textgreek[variant=ancient]{ἀπολλύναι τι,}\\
殺される \textgreek[variant=ancient]{ἀποθνήσκειν,}\\
彼らは追放された \textgreek[variant=ancient]{ἀνέστησαν,}\\
返答された \textgreek[variant=ancient]{ἤκουσα,}\\
よくしてもらう \textgreek[variant=ancient]{εὖ πάσχω,}\\
くじで選ばれた \textgreek[variant=ancient]{ἔλαχον,}\\
無罪となった \textgreek[variant=ancient]{ἀπέφυγον,}\\
悪しざまに言われた \textgreek[variant=ancient]{κακῶς ἤκουσα,}\\
（憐れみに）心を捉えられた \textgreek[variant=ancient]{(ἔλεός) με εἰσῄει.}
\end{quote}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
 \begin{quote}
称賛を受ける \textgreek[variant=ancient]{ἔπαινον ἔχειν,}\\
（盛んに）取り沙汰される \textgreek[variant=ancient]{λόγος ἐστὶ (πολύς),}\\
罰を受ける \textgreek[variant=ancient]{δίκην διδόναι,}\\
怒りが生じる \textgreek[variant=ancient]{ὀργὴ γίγνεται}、など。
\end{quote}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
形容詞と\textgreek[variant=ancient]{εἶναι}との組み合わせによる。例えば、
\end{japanese}
\switchcolumn*
...
\begin{japanese}
 \begin{quote}
はっきり見える \textgreek[variant=ancient]{καταφανῆ εἶναι,}\\
君の言うことは信じてもらえない \textgreek[variant=ancient]{ἄπιστος εἶ}
など。
\end{quote}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
ギリシャ語には、近代諸語に見られるような、目的語を明示するうえでの厳密さがない。
近代語では、結び合わされた二つの動詞が同じ目的語を異なる格で要求するとき、
第二の動詞のところでは名詞を繰り返さず、これに代えて人称代名詞を目的語として置く。
\kenten{これに対してギリシャ人は、第二の動詞がいかなる格を要求しようとも、共通の目的語に当たる項を明示しない。}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
また、フランス語の\textfrench{en}に相当する目的語（「そのうちのもの」「それを」）も、
ギリシャ語では表されない。例えば、
「彼らが（\ruby{それ}{金}を）欲するなら、彼らはリュディアから金を取り寄せさせねばなるまい」
\textgreek[variant=ancient]{ἐκ Λυδίας μεταστέλλεσθαι τὸ χρυσίον δεήσει αὐτοὺς, ἢν ἐπιθυμήσωσιν.}\footnote{ルーキーアーノス『神々の対話』15.2}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
ギリシャ語にもラテン語にも、近代諸語に見られる次のような強調構文はない\footnote{非人称主語を用いる構文は日本語にも無い。以下の例文はドイツ語の構造を保とうとしたものであるが、日本語として苦しい。}。
ドイツ語では、他の近代諸語と同じく、強調したい概念を、多くは非人称主語「\ruby{それ}{\textgerman{es}}」を伴う新たな文の述語とし、
残りの文成分を関係詞または接続詞で導かれる従属節として添える。
\kenten{ギリシャ語では、ある概念を強調するために一つの文を二つに分けるような構文を用いてはならない。}
例えば、

「これを言うのは同じ者である」\textgreek[variant=ancient]{ὁ αὐτὸς ταῦτα λέγει}.\\
「君が呼んでいる男は誰か」\textgreek[variant=ancient]{τίνα τὸν ἄνδρα καλεῖς;}\\
「君がこれをしたということ、それは本当か」\textgreek[variant=ancient]{ἆρ᾽ ἀληθῶς τοῦτ᾽ ἐποίησας;}\\
「……するということ、どうしてそれが可能なのか」「……するということ、どうしてそうなるのか」\textgreek[variant=ancient]{πῶς\ldots{};}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
ギリシャ語では、並列された文や文成分を接続のないままにしておくことはできない。
文成分を接続詞省略によって並べることはまれであり、とりわけ激しい感情を表す場合に用いられる。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
連続した談話では、\kenten{新しい文は一つ一つ}、適切な接続詞
（\textgreek[variant=ancient]{δέ, καί οὖν, γάρ}など）によって先行する文に\kenten{接続せねばならない}。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
学習者は、\textgreek[variant=ancient]{μέν}を、先行文との接続そのものを担う接続詞だと考えぬように注意すべきである。
\textgreek[variant=ancient]{μέν}は、後続するものを予告するにすぎないからである。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
連続した談話において、接続詞を伴わず新しい文が付け加えられるのは、次の場合に限られる。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
新しい文が\textgreek[variant=ancient]{εἶτα}（「それから」）または\textgreek[variant=ancient]{ἔπειτα}で始まるとき。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
ドイツ語なら\textgerman{nicht aber}「しかし……ではない」の如く対照的に否定するところ。この場合、\textgreek[variant=ancient]{οὐ}
（または\textgreek[variant=ancient]{μή}）だけを置くことが多い。\textgreek[variant=ancient]{οὐδέ}は
「……でもない」または「……さえない」を意味するからである。ただし、\textgreek[variant=ancient]{οὐ μέντοι}も多く用いられる。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
次の言い方に注意せよ。「さて、それでは……」：\textgreek[variant=ancient]{ἀλλά,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
「ああ、それなら……」：\textgreek[variant=ancient]{ἄρα,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
「すると彼は来た／すると彼は言った」：\textgreek[variant=ancient]{καὶ ἦλθε, καὶ εἶπεν,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
「というのも、さもなければ……」：\textgreek[variant=ancient]{γάρ,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
そして・では（推論）。例えば、「\kenten{では}、聞きたまえ」、
「\kenten{こうして}彼は……となったのである」：\textgreek[variant=ancient]{δή,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
「きっと……だろう（疑いなく）」：\textgreek[variant=ancient]{δήπου,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
「すると、もう……」：\textgreek[variant=ancient]{καὶ δή}
（ここでは\textgreek[variant=ancient]{δή}＝\textgreek[variant=ancient]{ἤδη}）。
比較：\textgreek[variant=ancient]{πάλαι δή}「もうとうに」、
\textgreek[variant=ancient]{νῦν δή}「たった今」。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
「しかし……ではある」：\textgreek[variant=ancient]{δὲ,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
「そうして初めて／その時になって初めて」：\textgreek[variant=ancient]{οὕτω δή,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
「……であることは確かだ」：\textgreek[variant=ancient]{\ldots{} μήν,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
「とはいえ……」：\textgreek[variant=ancient]{οὐ μὴν ἀλλά,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
副詞的な「おそらく……だろう」：\textgreek[variant=ancient]{ἦ που \ldots{}}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
否定文に続く「また……ない／……もない」：\textgreek[variant=ancient]{οὐδέ, μηδέ,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
依頼などを強める「どうか／ねえ」（ラテン語 \textlatin{quaeso} の意）：\textgreek[variant=ancient]{δῆτα,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\begin{tabular}{ll}
\ldelim\{{2}{1em}[] & \textgreek[variant=ancient]{οὐ τοσοῦτον ὅσον \ldots{}}\tabularnewline
 & \textgreek[variant=ancient]{οὐ τὸ πλέον \ldots{} ἀλλὰ \ldots{}}\tabularnewline
\end{tabular}
\end{japanese}
\switchcolumn*
\egroup
...
\begin{japanese}
「ああ、それなら……」をどの場合にも \textgreek[variant=ancient]{ἄρα} で適切に表せるからといって、
逆に \textgreek[variant=ancient]{ἄρα} をどの場合にも「ああ、それなら……」と適切に訳せるということには、決してならない。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\kenten{大きな}幸運 \textgreek[variant=ancient]{πολλὴ εὐδαιμονία.}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
「ある」「持つ」および継続を表す動詞の\kenten{完了}は、ギリシア語では未完了過去で表される。
...
\begin{japanese}
その金は\kenten{見つかったか}（今や） \textgreek[variant=ancient]{ἆρ᾽ εὕρηκας τἀργύριον;}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
はい、\kenten{見つけました}（今や） \textgreek[variant=ancient]{εὕρηκανὴ Δία.}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
どこで\kenten{見つけたのか}（その時） \textgreek[variant=ancient]{ποῦ εὗρες;}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
私は（その時）庭で\kenten{見つけた} \textgreek[variant=ancient]{ἐν τῷ κήπῳ εὗρον.}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\textgreek[variant=ancient]{φησὶν εὑρεῖν}＝彼は\kenten{見つけた}と言っている。
\end{japanese}
\switchcolumn*
\end{continuousexamples}
...
\begin{japanese}
\kenten{daß} が「〜させよ／〜になるように」という意味なら、
...
\begin{japanese}
\kenten{sein} の代わりに \kenten{gehen} を想定できるところでは
...
\begin{japanese}
\kenten{zu, allzu} は多くの場合訳さない。例えば「私たちは少なすぎる」
...
\begin{japanese}
\kenten{この二人の}老紳士 \textgreek[variant=ancient]{τὼ πρεσβύτα τώδε.}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\kenten{この二人} \textgreek[variant=ancient]{τώδε (ἄμφω).}
\end{japanese}
\switchcolumn*
\end{continuousitemline}
...
\begin{japanese}
\textgreek[variant=ancient]{ἄμφω} は常に、添えられる名詞に\kenten{双数}を要求する。
\textgreek[variant=ancient]{ἀμφότερος} はたいてい名詞を\kenten{複数}にして用いる。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
私は\kenten{これら}（例えば息子）の方を、あれら（娘）より多く持っている
...
\begin{japanese}
私は\kenten{（先へ）進む} \textgreek[variant=ancient]{χωρῶ,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
私は彼を\kenten{訪ねる}つもりだ \textgreek[variant=ancient]{εἶμι (εἴσειμι)
ὡς αὐτόν,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
私は彼に尋ねる\kenten{ために}行くつもりだ \textgreek[variant=ancient]{εἶμι
ἐρωτήσων αὐτόν.}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
私は一緒に食事をする\kenten{ために}こちらへ来る \textgreek[variant=ancient]{ἔρχομαι
δειπνήσων.}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\kenten{外へ}出る \textgreek[variant=ancient]{θύραζε ἐξιέναι} または
\textgreek[variant=ancient]{θ. βαδίζειν.}
\end{japanese}
\switchcolumn*
\end{continuousitemline}
...
\begin{japanese}
\kenten{優秀な}生徒たち \textgreek[variant=ancient]{οἱ ἀγαθοὶ τῶν
μαθητῶν.}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
優秀な\kenten{生徒たち} \textgreek[variant=ancient]{οἱ ἀγαθοὶ μαθηταί.}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\kenten{ほら}、若者がやって来る！ \textgreek[variant=ancient]{τὸ
μειράκιον \emph{τοδὶ} (τόδε) προσέρχεται!}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
私は\kenten{食べるものを何も}持っていない \textgreek[variant=ancient]{οὐκ ἔχω
καταφαγεῖν.}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\kenten{ここ}、すなわち\kenten{話し手}のいる場所を指す場合は \textgreek[variant=ancient]{ἐνθάδε,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
ここ（話し手の場所に\kenten{近い}ところ）は \textgreek[variant=ancient]{ἐνταῦθα,}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
ここ（＝\kenten{その場で}、まさにその場所で）は \textgreek[variant=ancient]{αὐτοῦ.}
\end{japanese}
\switchcolumn*
\end{continuousitemline}
...
\begin{japanese}
私はホメロスの詩を\kenten{暗記して}学ぶ \textgreek[variant=ancient]{μανθάνω
τὰ Ὁμήρου ἔπη.}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
私はイリアスを\kenten{暗唱できる} \textgreek[variant=ancient]{ἐπίσταμαι Ἰλιάδα.}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
私はオデュッセイアを\kenten{暗唱して言う}ことができるだろう
...
\begin{japanese}
私は君より多くの金を持っているが、カールが\kenten{最も}多く持っている
...
\begin{japanese}
彼は私から\kenten{私の}金を盗んだ \textgreek[variant=ancient]{ὑπείλετό
μου τἀργύρια.}
\end{japanese}
\switchcolumn*
\end{continuousitemline}
...
\begin{japanese}
\kenten{取る}などの動詞では、所有によって示される人物がすでに言及されているなら、
所有代名詞を訳してはならない。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\kenten{何か}必要か？ \textgreek[variant=ancient]{δέει \emph{τίνος;}}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\kenten{何か}新しいことが言われているか？ \textgreek[variant=ancient]{λέγεται
\emph{τί} καινόν;}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
少額の\kenten{金} \textgreek[variant=ancient]{ἀργύριον.}
\end{japanese}
\switchcolumn*
...
\kenten{am Ende}（＝結局、もしかすると）に正確に対応する。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\kenten{〜の中に}＝その間に、の意味では \textgreek[variant=ancient]{ἐν,} 例えば
\textgreek[variant=ancient]{ἐν τοῖς Χριστιανοῖς πολλοί εἰσιν Ἰουδαῖοι.
ἐν νέοις ἀνὴρ γέρων.}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\kenten{特に〜ではない} \textgreek[variant=ancient]{οὐ πάνυ.}
...
\begin{japanese}
ギリシア語で副詞の自然な位置は、それが限定する概念の\kenten{前}である。
この位置から外れる場合は、副詞を強調するためである。
副詞が強勢を伴って最後に置かれると、この位置がドイツ語の
\kenten{und zwar} に相当する：
...
感嘆文は関係詞、それも\kenten{単純な}関係詞で始まる。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
ドイツ人は「彼は\emph{\ruby{どこへ}{Wohin}}座るのか」と問うが、ギリシア人は「\kenten{どこに}」と問う。
...
\begin{japanese}
\kenten{誰もかれも}（\textfrench{tout le monde}）は
...
\begin{japanese}
\kenten{〜するために} はしばしば \textgreek[variant=ancient]{βουλόμενος} で表される。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\kenten{〜よりむしろ} \ldots{} ＝〜より先に \ldots{} は
...
\begin{japanese}
\kenten{先ほど} は \textgreek[variant=ancient]{τότε} という。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
私たちが \kenten{so} (mach') \kenten{doch} で表す催促的命令法を、
...
\kenten{「神々にかけての誓言」}では決してなく、\kenten{懇願}の定型句である。
\end{japanese}
\switchcolumn*
...
だけがあるのではない。\kenten{未来}の反実仮想も存在しなければならない。
...
\begin{japanese}
\kenten{注意} \textgreek[variant=ancient]{φαίη δ᾽ ἂν ἡ θανοῦσα, εἰ φωνὴν λάβοι}
のような例では、希求法が過去時制の代わりに異例に用いられているのではない。
むしろ無数の類例と同じく、規則どおり未来の反実仮想を示している。
すなわち「死者が\kenten{将来いつか}戻って来るなら、彼女はそれを確証するだろう」という意味である。
\end{japanese}
\switchcolumn*
