...
\begin{japanese}
ギリシア語特有の色合いをまねるには、まず次の点を守らねばならない；
\end{japanese}
\switchcolumn*
...
\begin{japanese}
\emph{中動態と同じ形の受動態はできるだけ避け、それをギリシア人ならどう言い換えるものであったかに目を配ること。}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
受動形のうち、文脈からすぐに受動と分かるものや、慣用として頻繁に用いられる形だけが安心して使える。
\end{japanese}
\switchcolumn*
...
未訳\todo{要分割}
\begin{quote}
助言されること\todo{要検証}＝\textgreek[variant=ancient]{μανθάνειν}、\\
称賛されること＝\textgreek[variant=ancient]{εὐδοκιμεῖν}、\\
悩まされること＝\textgreek[variant=ancient]{κάμνειν}、\\
訴追されること＝\textgreek[variant=ancient]{εἰσιέναι εἰς δικαστήριον}、\\
告発されること＝\textgreek[variant=ancient]{φεύγειν}、\\
……と見なされること＝\textgreek[variant=ancient]{δοκεῖν}、\\
何かが私に起こること＝\textgreek[variant=ancient]{πάσχω τι}、\\
追放されること＝\textgreek[variant=ancient]{ἐκπίπτειν}、\\
何かを奪われること＝\textgreek[variant=ancient]{ἀπολλύναι τι}、\\
殺されること＝\textgreek[variant=ancient]{ἀποθνήσκειν}、\\
彼らは追い払われた＝\textgreek[variant=ancient]{ἀνέστησαν}、\\
返答された＝\textgreek[variant=ancient]{ἤκουσα}、\\
恩恵を示される＝\textgreek[variant=ancient]{εὖ πάσχω}、\\
くじで選ばれた＝\textgreek[variant=ancient]{ἔλαχον}、\\
無罪判決を下された＝\textgreek[variant=ancient]{ἀπέφυγον}、\\
罵倒を浴びた＝\textgreek[variant=ancient]{κακῶς ἤκουσα}、\\
（憐れみ）に打たれた＝\textgreek[variant=ancient]{(ἔλεός) με εἰσῄει}。
\end{quote}
\end{japanese}
\switchcolumn*
...
\begin{japanese}
しばしば\textgreek[variant=ancient]{γίγνεσθαι}で置き換えられる。これは「作られる・
催される・成し遂げられる・委譲される\todo{\textgerman{übertragen}はどういう意味
  なんだろうか}・授与される・購われる・獲得される・（悪事が）犯される・（祭りが）執り行われる・生まれる」など多くの受動を代表する。
\end{japanese}
\switchcolumn*
