...
\begin{japanese}
ギリシア語はラテン語と同様、文中の一部を強調するための手段に欠けている。つまり、私たちの言語や他の近代語が、
強調したい語を新しい文の述語にし、残りを関係詞や接続詞で従属節として付け加えるという方法を持つのに対し、
...
接続詞なしに並べる用法はまれで、激しい感情の表現として用いられる場合に限られる。
\end{japanese}
\switchcolumn*
...
\begin{japanese}
さてそれで……＝\textgreek[variant=ancient]{ἄρα,}
\end{japanese}
\switchcolumn*
