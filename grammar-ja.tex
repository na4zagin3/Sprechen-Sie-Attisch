...
\begin{japanese}
\item その言語の習得を容易たらしめるものとして、言語の\emph{弱点}を見抜くことほ
  どのものはない。ある言語にどこが欠けているかが分かって初めて、ある言い回しを選
  んだり、ある語の組み合わせを好む理由、そして我々の母語の表現法と異なる理由が真
  に理解できるのだ。その言語の\emph{精神}ーー即ち特殊性の総体ーーの肝が掴めるようになる。
