...
\kenten{その知識}により、ソ\jdb{ポ}クレースの劇やペリクレースの演説が理解できたのだ。
...
この目的に十分な言語資料を提供している。
その他の文学作品にも、市井の暮らしの言葉の忠実な模倣と見なさねばならない箇所が散在している。%
...
\begin{japanese}
第二に、文学作品における言語の\kenten{色合い}や文体の種類は、
その言葉が日常語からどれほど\kenten{隔たっている}かを測りうる者にだけ、正しく見て取れるものである。
仮にドイツ語をシラーだけから学んだ人がいれば、その人にはシラーの語法の独自性や高みを理解する感覚が欠けていよう。
\kenten{日常性}の言葉から出発して近づく者だけが、その尺度を携えている。
ギリシャ語でも相違なかろう。
\end{japanese}
\switchcolumn*
...
とりわけドイツ語とギリシャ語の\kenten{表現の比較}を余儀なくさせ、
語句の比較が素早く容易に行えるようにすることで
ギリシャ語からの翻訳の確かさや
自然さを高めるものである。
言語の\kenten{精神}と呼ばれるものは、諸言語相互の比較が\kenten{容易}で\kenten{自然に思いつく}ところ、
...
わが国のギムナジウムにおけるギリシャ語の学習に、これほど多くの\kenten{反対者}を生んだものは、
...
教育の不備を嘆くのはまったく当然であり、
かかる不確かさは、ラテン語の\kenten{著作}の\kenten{意味}を確実に捉えることの上でも害になるとみなされよう。
ところが、ギリシャ語ではどうか。
試してみれば、ア\jdb{テ}ーナイ人の日常の言い回しである
「\textgreek[variant=ancient]{ἥξω παρὰ σέ}」がすぐ口をついて出る者は、驚くほど少なかろう。
ギリシャ語では、言語の\kenten{法則}を熱心に研究しながら、\kenten{言語}そのものはほとんど学ばない。
